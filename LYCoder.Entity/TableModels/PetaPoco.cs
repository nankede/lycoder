...
#pragma warning disable 1066,1570,1573,1591
    ...
    public partial class Database : IDatabase
    {
        ...
        public int Execute(string sql, params object[] args)
        {
            ...
            {
                LogHelper.Error(x.Message + sql + x.StackTrace);
                if (OnException(x))
                    throw;
                return -1;
            }
        ...
        public IEnumerable<T> Query<T>(string sql, params object[] args)
        {
            ...
            try
            {
                using (var cmd = CreateCommand(_sharedConnection, sql, args))
                {
                    ...
                    {
                        LogHelper.Error(x.Message + FormatCommand(cmd) + x.StackTrace);
                        if (OnException(x))
                            throw;
                        yield break;
                    }
    ...
    public abstract class DatabaseProvider : IProvider
    {
        ...
        protected DbProviderFactory GetFactory(string assemblyQualifiedName)
        {
            ...
            // var ft = asmb.GetType(assemblyQualifiedName);
            var cc = new MySql.Data.MySqlClient.MySqlClientFactory();
            var ft = cc.GetType();
    ...
    public class Sql
    {
        ...
        {
            return string.IsNullOrEmpty(sql) ? null : Append(new Sql("WHERE (" + sql + ")", args));
        }
